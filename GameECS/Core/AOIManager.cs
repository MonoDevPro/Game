...
public sealed class AOIManager(World world) : IAOIManager
{
        ...
        in VisibilityConfig config)
    {
        ...
        world.Query(in _entityQuery, (Entity entity, ref Identity identity, ref GridPosition entityPos) =>
        {
            ...
            if (distance <= viewRadius)
            {
                ...
                if (world.Has<Invisible>(entity) || world.Has<Hidden>(entity))
                    return;
