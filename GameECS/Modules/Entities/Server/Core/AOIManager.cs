...
public sealed class AOIManager
{
    ...
    public AOIManager(World world)
    {
        ...
        _entityQuery = new QueryDescription()
            .WithAll<EntityIdentity, GridPosition>();
    }
        ...
        in VisibilityConfig config)
    {
        ...
        _world.Query(in _entityQuery, (Entity entity, ref EntityIdentity identity, ref GridPosition entityPos) =>
        {
    ...
    {
        if (_world.Has<EntityIdentity>(entity))
        {
