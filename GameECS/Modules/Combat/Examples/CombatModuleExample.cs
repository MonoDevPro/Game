...
namespace GameECS.Modules.Combat.Examples;
...
public static class CombatModuleExample
{
    ...
    public static void ServerExample()
    {
        ...
        var knight = combatModule.CreateCombatant(VocationType.Knight, level: 5);
    ...
    public static void ClientExample()
    {
        ...
        clientCombat.OnDamageReceived(new DamageNetworkMessage
        {
            AttackerId = 1,
            TargetId = 2,
            Damage = 25,
