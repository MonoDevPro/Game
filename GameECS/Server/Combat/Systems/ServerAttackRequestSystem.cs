...
public sealed partial class ServerAttackRequestSystem : BaseSystem<World, long>
{
    ...
    private readonly Action<DamageMessage>? _onDamageDealt;
    private readonly Action<DeathMessage>? _onEntityDeath;
    ...
    public ServerAttackRequestSystem(
        ...
        Action<DamageMessage>? onDamageDealt = null,
        Action<DeathMessage>? onEntityDeath = null) : base(world)
    {
