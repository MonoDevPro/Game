...
internal class GameDbContext(DbContextOptions<GameDbContext> options) : DbContext(options)
{
    ...
    public DbSet<PlayerSimulationAttributes> Stats { get; set; }
    ...
    private void ConfigureCharacter(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Character>(entity =>
        {
            ...
            entity.HasIndex(e => new { Floor = e.PositionZ, e.PositionX, e.PositionY })
            ...
            entity.HasOne(e => e.Stats)
                ...
                .HasForeignKey<PlayerSimulationAttributes>(s => s.CharacterId)
                .OnDelete(DeleteBehavior.Cascade)
    ...
    {
        modelBuilder.Entity<PlayerSimulationAttributes>(entity =>
        {
            entity.HasKey(e => e.Id);
