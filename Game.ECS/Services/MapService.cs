...
public class MapService
{
    ...
    public MapService(int id, string name, int width, int height, bool usePadded, bool borderBlocked = true)
    {
        Id = id;
    ...
    private int LinearPos(Coordinate p) => p.Y * Width + p.X;
    ...
    public void PopulateFromRowMajor(byte[] tilesRowMajor, byte[] collisionRowMajor)
    {
