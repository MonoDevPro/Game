...
/// </summary>
public sealed class QuadTreeSpatialService(int minX, int minY, int width, int height)
    : ISpatialService
{
    ...
    public void BeginFrame(uint tick) { /* no-op (opcional) */ }
    public void EndFrame() { /* no-op (opcional) */ }
