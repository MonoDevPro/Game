...
namespace Game.Core.Sync;

/// <summary>
/// Sistema responsável por coletar componentes marcados como dirty e emitir atualizações de estado.
/// </summary>
public sealed partial class ServerSyncSystem(World world, PacketSender sender) : GameSystem(world)
{
    [Query]
        ...
        ref DirtyFlags dirty)
    {
            ...
            World.TryGet(entity, out Position position) && World.TryGet(entity, out Facing facing))
        {
            ...
            sender.SendToAll(ref updatePacket, NetworkChannel.Simulation, DeliveryMethod.ReliableOrdered);
        }
