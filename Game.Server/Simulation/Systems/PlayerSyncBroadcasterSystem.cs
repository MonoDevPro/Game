    ...
    : GameSystem(world)
{
    ...
    private void BroadcastMovement(in Entity entity, ref NetworkId netId, ref Position pos, ref Facing dir, in Walkable speed, ref NetworkDirty dirty)
    {
        ...
        var packet = new PlayerMovementPacket(netId.Value, pos.X, pos.Y, pos.Z, dir.DirectionX, dir.DirectionY, effectiveSpeed);
