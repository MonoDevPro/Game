...
namespace Game.ECS.Shared.Data.Navigation;

/// <summary>
/// Snapshot de movimento para sincronização.
/// Enviado do servidor para o cliente.
/// </summary>
[MemoryPackable] public partial struct MovementSnapshot
{
    public int EntityId;
...
/// </summary>
[MemoryPackable] public partial struct BatchMovementUpdate
{
...
/// </summary>
[MemoryPackable] public partial struct TeleportMessage
{
    public int EntityId;
    public short X;
    public short Y;
...
/// </summary>
[MemoryPackable] public partial struct MoveInput
{
...
/// </summary>
[MemoryPackable] public partial struct MoveConfirmation
{
    public int SequenceId;
    public bool Success;
    public short FinalX;
