...
public sealed partial class EntitySaveSystem(World world, IRepository<int, PlayerData> memoryRepo, IPlayerStagingArea playerStagingArea) : BaseSystem<World, float>(world)
{
    [Query]
